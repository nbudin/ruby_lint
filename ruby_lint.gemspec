...
Gem::Specification.new do |s|
  ...
  s.description = <<-DESCRIPTION
    RubyLint is a Ruby code style checking and code formatting tool.
  ...
  s.files = `git ls-files assets bin config lib LICENSE.txt README.md`
            .split($RS)
  s.bindir = 'exe'
  s.executables = ['ruby_lint']
  s.extra_rdoc_files = ['LICENSE.txt', 'README.md']
  s.homepage = 'https://github.com/ruby-lint/ruby_lint'
  s.licenses = ['MIT']
  s.summary = 'Automatic Ruby code style checking tool.'

  s.metadata = {
    'homepage_uri' => 'https://rubocop.org/',
    'changelog_uri' => 'https://github.com/ruby-lint/ruby_lint/blob/master/CHANGELOG.md',
    'source_code_uri' => 'https://github.com/ruby-lint/ruby_lint/',
    'documentation_uri' => 'https://docs.rubocop.org/',
    'bug_tracker_uri' => 'https://github.com/ruby-lint/ruby_lint/issues'
  }
